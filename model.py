# Modified for steel scrap recognition project
# Auther:Gong
...
#     x = BatchNorm(axis=3, name=bn_name_base + '2a')(input_tensor)
#     x = KL.Activation('relu')(x)
#     x = KL.Conv2D(nb_filter1, (1, 1), name=conv_name_base + '2a',
#                   use_bias=use_bias)(x)
...
def resnet_graph(input_image, architecture, stage5=False):
    assert architecture in ["steel_scrpa_50", "steel_scrap_101"]
    # Stage 1
    ...
    block_count = {"steel_scrpa_50": 5, "steel_scrap_101": 22}[architecture]
